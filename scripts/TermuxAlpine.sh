...
# Copyright ©2020 by WaSim Akram. All rights reserved.
# You Don't become a Hacker or Coder By copying source file
...
#!/data/data/com.termux/files/usr/bin/bash -e
unset LD_PRELOAD
# thnx to WaSim Akram for DNS picker
addresolvconf ()
{
...
finalwork() {
	[ ! -e ${DESTINATION}/finaltouchup.sh ] && curl --silent -LO https://raw.githubusercontent.com/evildevill/Apkmod/master/scripts/finaltouchup.sh
	if [ "${MOTD}" = "ON" ]; then
...
printline
printline
printf "\n${blue} [*] Email   :${yellow}    hackerwasi1@gmail.com\n"
printf "$blue [*] Website :${yellow}    https://hackerwasii.blogspot.com\n"
printf "$blue [*] YouTube :${yellow}    https://youtube.com/thelinuxchoice\n"
printline
